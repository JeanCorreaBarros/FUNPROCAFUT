...
export function ConfiguracionWelcomeBanner() {
  const { user } = useAuth()

  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-bivoo p-6 md:p-8 text-white">
      <div className="relative z-10">
        <h1 className="text-2xl md:text-3xl font-bold mb-2 text-balance">Configuración General</h1>
        <p className="text-white/90 mb-6 max-w-2xl text-pretty">
          Administra la configuración de tu sistema y personaliza tu experiencia.
        </p>
        ...
        <div className="flex flex-wrap gap-6 text-sm">
          ...
          <div className="flex items-center space-x-2">
            ...
            <span>Usuarios activos: 7</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-white rounded-full"></div>
            <span>Última configuración: hoy</span>
          </div>
        </div>
      </div>
