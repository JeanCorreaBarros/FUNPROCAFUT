...
export function MarketingWelcomeBanner() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-gradient-bivoo p-6 md:p-8 text-white">
      <div className="relative z-10">
        <h1 className="text-2xl md:text-3xl font-bold mb-2 text-balance">Marketing Digital</h1>
        <p className="text-white/90 mb-6 max-w-2xl text-pretty">
          Gestiona tus campañas de marketing y analiza el rendimiento de tus estrategias.
        </p>

        <div className="flex flex-wrap gap-6 text-sm">
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
            <span>Campañas activas: 3</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-white rounded-full"></div>
            <span>Alcance: 2,450 personas</span>
          </div>
          <div className="flex items-center space-x-2">
            <div className="w-2 h-2 bg-white rounded-full"></div>
            <span>Conversión: 12.5%</span>
          </div>
        </div>
      </div>
