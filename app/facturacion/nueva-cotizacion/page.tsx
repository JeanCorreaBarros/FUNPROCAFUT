...
export default function NuevaFacturaPage() {
    ...
    const handleEmitInvoice = async () => {
        ...
        try {
            ...
            const res = await fetch("http://localhost:3000/api/modules/factura/invoices", {
                method: "POST",
                headers: myHeaders,
            ...
            for (const it of items) {
                ...
                try {
                    const resDetail = await fetch("http://localhost:3000/api/modules/factura/invoicesDetails", {
                        method: "POST",
                        headers: myHeaders,
                ...
                <ModuleLayout moduleType="facturacion">
                    <main className="flex-1 overflow-y-auto p-9 ">
                        ...
                        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-6">
                            <div className="max-w-md text-center bg-white rounded-xl shadow-sm p-6">
                    ...
                    >
                        ...
                        <motion.div variants={itemVariants} className="flex justify-between items-center mb-6">
                            <div className="flex items-center">
                                <Link href="/facturacion/cotizacion">
                                    <Button variant="ghost" size="icon" className="mr-2">
                                        <ArrowLeft className="h-5 w-5" />
                                    </Button>
                                </Link>
                                <h1 className="text-2xl font-bold">Nueva Cotizacion de Venta</h1>
                            </div>
                        ...
                        <motion.div variants={itemVariants} className="flex flex-col md:flex-row justify-between items-start mb-6">
                            ...
                            <div className="flex-1 px-8 my-4 md:my-0">
                                <div className="text-center">
                                    <h2 className="text-lg font-semibold">BIVOO BARBERÍA & ESTÉTICA</h2>
                                    <p className="text-gray-600">NIT: 900.123.456-7</p>
                                    <p className="text-gray-600">contacto@bivoo.com</p>
                            ...
                            <div className="w-48">
                                <div className="flex items-center gap-2 mb-2">
                                    ...
                                    <span className="text-blue-600">BIVOO-001</span>
