...
export default function EducativePage() {
    ...
    const sampleCourses = [
        { id: 1, name: "Matemáticas", teacher: "Marta López", progress: 78 },
        { id: 2, name: "Lenguaje", teacher: "Carlos Pérez", progress: 92 },
        { id: 3, name: "Ciencias", teacher: "Ana Gómez", progress: 64 },
    ]
    ...
    return (
        <AuthGuard>
            <ModuleLayout moduleType="educative">
